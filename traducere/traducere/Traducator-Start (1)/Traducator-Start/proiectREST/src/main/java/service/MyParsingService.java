...
public class MyParsingService extends DefaultHandler {
    private File file;

    public MyParsingService(File file) {
        this.file = file;
    }
    ...
    public String traducereXML(String word, String origLanguage, String destLanguage) throws FileNotFoundException {
